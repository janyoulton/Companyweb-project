...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <classAccesses>
        <apexClass>AsyncConnectCompanywebBe</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>CompanyWebController</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>companyWebCallOutMock</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>companyWebCallOutMockEmpty</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>companyWebControllerTest</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>companyWebNegativeCallOutMock</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>companyWebSearchCallOutMock</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>companyWebSearchNegativeCallOutMock</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>connectCompanywebBe</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <custom>false</custom>
    <customMetadataTypeAccesses>
        <enabled>true</enabled>
        <name>CW_Login_Setup__mdt</name>
    </customMetadataTypeAccesses>
    <fieldPermissions>
        <editable>true</editable>
        <field>CW_Login_Setup__mdt.Account_Activities_Field__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>CW_Login_Setup__mdt.Account_Credit_Limit_Field__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>CW_Login_Setup__mdt.Account_Joint_Commitees_Field__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>CW_Login_Setup__mdt.Account_Joint_Commitees_White_Field__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>CW_Login_Setup__mdt.Account_Legal_Form_Field__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>CW_Login_Setup__mdt.Account_Main_Activity_Field__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>CW_Login_Setup__mdt.Account_Number_Employees_Field__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>CW_Login_Setup__mdt.Account_Score_Field__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>CW_Login_Setup__mdt.Account_Social_Security_Field__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>CW_Login_Setup__mdt.Account_VAT_Number_Field__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>CW_Login_Setup__mdt.CW_CompanyWebLogin__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>CW_Login_Setup__mdt.CW_CompanyWebPassword__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>CW_Login_Setup__mdt.CW_CompanyWebSecret__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>CW_Login_Setup__mdt.CW_Duplicate_Check_Creation__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>CW_Login_Setup__mdt.CW_Duplicate_Check_Refresh__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>CW_Login_Setup__mdt.CW_ServiceIntegrator__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>CW_Login_Setup__mdt.Lead_Activities_Field__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>CW_Login_Setup__mdt.Lead_Credit_Limit_Field__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>CW_Login_Setup__mdt.Lead_Joint_Commitees_Field__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>CW_Login_Setup__mdt.Lead_Joint_Commitees_White_Field__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>CW_Login_Setup__mdt.Lead_Legal_Form_Field__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>CW_Login_Setup__mdt.Lead_Main_Activity_Field__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>CW_Login_Setup__mdt.Lead_Number_Employees_Field__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>CW_Login_Setup__mdt.Lead_Score_Field__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>CW_Login_Setup__mdt.Lead_Social_Security_Field__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>CW_Login_Setup__mdt.Lead_VAT_Number_Field__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <flowAccesses>
        <enabled>false</enabled>
        <flow>Call_CompanyWeb_API_on_Account_Creation_Flow</flow>
    </flowAccesses>
    <flowAccesses>
        <enabled>false</enabled>
        <flow>Call_CompanyWeb_API_on_Lead_Creation_Flow</flow>
    </flowAccesses>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>CW_Login_Setup__mdt-Login Setup Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
